...
export default async function CommissionsPage({ searchParams }: { searchParams: Promise<{ ref?: string }> }) {
  const { ref } = await searchParams;
  const work = ref ? await getWork(ref) : undefined;
  return (
    <>
